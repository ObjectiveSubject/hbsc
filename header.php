            ...
            <div class="u-container">
                <div class="site-header__content">
                    <address class="u-display-block-md">
                        <a href="#" class="utility-toggle class-toggle" data-target="#masthead" data-class="utility-location-open">
                            <?php echo get_option('hbsc_address'); ?>
                        </a>
                    </address>
                    <div class="u-display-block-md">
                        <a href="#" class="utility-toggle class-toggle" data-target="#masthead" data-class="utility-search-open" data-focus=".search-field"><span class="icon icon-search"></span></a>
                    </div>
                    <div class="open--hours">
                        <a href="#" class="utility-toggle class-toggle" data-target="#masthead" data-class="utility-hours-open">
                            <?php
